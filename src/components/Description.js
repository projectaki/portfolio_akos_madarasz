...
class Description extends Component {
    render() {
        return (
            <div>  
                <h5 className="bold-style resp-h-size league-spartan" style={{"color": "#E4ED20", paddingLeft: 0, paddingBottom: "5vh"}}>&lt;Profile&gt;</h5>
                <div style={{paddingLeft: "1vw", paddingRight:"1vw", textAlign: "justify"}}>
                    <p className="resp-p-size league-spartan" style={{ color: "white"}}>
