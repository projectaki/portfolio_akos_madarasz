            ...
            <div>
                <div className="container pad-left-right">
                    <div class="row no-margin">
                        ...
                        <div class="card" style={{"background-color": "#7A71AA"}}>
                            <div class="card-content black-text">
                            <h5 className="bold-style no-padding italic-style" style={{"color": "black"}}>My Projects</h5>
                            <br/>
                            <p className="italic-style resp-p-size" style={{"color": "white", paddingLeft: "0%"}}>
